...
\begin{displaymath}
  \hat{R_{ij}} \approx \frac{e_i^{+} - e_i^{-}}{2\Delta\gamma_j}\ .
\end{displaymath}
where $\hat{R_{ij}}$ is the estimated response of the object to shear
...
other observational effects when computing $\hat R_{ij}$. Note that as the
