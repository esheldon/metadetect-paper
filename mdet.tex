...
\begin{abstract}
    ...
    and that this bias increases with increasing galaxy number density.  We show that
    ...
    spatially varying point-spread-function, does not result in a significant
    bias for typical imaging surveys.  Finally, we discuss additional technical
...
signficiantly increases the blending of images, so accurate performance in this
