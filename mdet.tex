...
\subsection{Bias in Simulations with Representative Galaxy Density}

Erin's tests with WeakLensingDeblending and Matt's tests

\section{Mitigating Shear-dependent Detection Biases with \Mcal}
blah

\subsection{Simulation Tests with Galaxy Pairs}

Erin's results with pairs

\subsection{Simulation Tests with Representative Galaxy Density}

Erin's results with WeakLensingDeblending and Matt's tests without
psf variation or masking

\subsection{Tests with Realistic Masking and PSF Variation}
