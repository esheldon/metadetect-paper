...
The images input to the coadd can have significant spatial variations in their
world coordinate system (WCS) transformations,  which complicates the
application of an artificial shear. The simplest way to deal with this may be
