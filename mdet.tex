...
uncalibrated ellipticity measurement, which can have large shear biases
($\sim10$\%) and large, unknown selection effects.  The final shear
meausrements are then calibrated, including selection effects, using a
...
is to make these biases as small as possible, sub-percent as opposed to 10
percent, which greatly reduces the sensitivity of the final calibration to
