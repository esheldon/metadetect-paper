...
doing so results in shear biases because using only matched objects imparts a
shear dependent selection onto the matched catalogs. This fact has implications
