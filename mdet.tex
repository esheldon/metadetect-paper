...
\begin{abstract}
    ...
    current surveys, and increases to tens of percent for future surveys.  This
    bias is due to shear-dependent selection rather than blending itself; if
    detection is shear independent, no de-blending of images is needed, in
    principle.  Shear-dependent selection bias are completely accounted for
    when including detection in the \mcal\ process.
