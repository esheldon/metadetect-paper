...
\cite{SheldonMcal2017}.  Also, interpolation correlates the noise in the image,
so the noise field used for correcting correlated noise effects must also be
propagated through the same interpolation \cite{SheldonMcal2017}.
