...
images: the effective area of the PSF a factor of two smaller DES PSF.  The
images of galaxies at fixed density will overlap less in LSST images than they
do in DES images.  Note also that this procedure closely matches that currently
done for DES year 5 processing.  We see similar biases when no de-blending is
performed.
