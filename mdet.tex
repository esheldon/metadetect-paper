...
\begin{abstract}
    ...
    ultimately limited by how closely this process matches images in real data,
    where some, but not all galaxies in an image are sheared coherently.  We
    find that even for the worst case scenario, in which the space between
    objects is completely unsheared, the bias is at most a few tenths of a
    percent for future surveys.  We show that the primary technical challenge
