...
shear estimates in simulations with realistic, LSST-like \citep[e.g.,][]{chang2013} levels of object
...
spatial point-spread function (PSF) variation.
...
matching those used for DES year 5 survey reductions (Bechtol et al, in prep.).
...
simulations have the advantage of having very low shape noise and so are ideal
