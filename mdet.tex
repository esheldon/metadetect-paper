...
\begin{table}
  ...
  \begin{tabular}{|l|l|c|c|}
    ...
    \hline
    \hline
    DES & MOF+metacal    & \snr$ > 10$ & $-0.063 \pm 0.001$  \\
    DES & MOF+metacal    & \snr$ > 15$ & $-0.050 \pm 0.001$  \\
    DES & MOF+metacal    & \snr$ > 20$ & $-0.041 \pm 0.001$  \\
    \hline
    LSST  & MOF+metacal    & \snr$ > 10$ & $-0.086 \pm 0.005$  \\
    LSST  & MOF+metacal    & \snr$ > 15$ & $-0.073 \pm 0.004$  \\
    LSST  & MOF+metacal    & \snr$ > 20$ & $-0.059 \pm 0.004$  \\
    \hline
  \end{tabular}
...
\begin{table}
  ...
  \caption{
    ...
    simulations have no PSF variation or masking.  No deblending was performed,
    and simple weighted moments were used without PSF correction.
    In all cases a cut of $T/T_{PSF} > 1.2$ was also applied.
    \label{tab:mdet:constpsf}
  }
