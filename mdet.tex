...
\begin{abstract}
    ...
    some, but not all, galaxies images are sheared coherently.  We find that
    even for the worst case scenario, in which the space between objects is
...
separate objects is ``blended''\footnote{In \cite{FPFS2018} blending related
biases were corrected using simulations.}\citep[for discussion of blending
