...
In this section we describe simulations with parameters chosen to mimic
DES and LSST images.  We used the publicly available
\texttt{WeakLensingDeblending}\footnote{\url{https://github.com/LSSTDESC/WeakLensingDeblending}
to generate galaxy catalogs and images.
