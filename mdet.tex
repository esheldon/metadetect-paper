...
\ref{fig:toy}, demonstrating the extreme and unrealistic case of two
...
\begin{figure*}
  \includegraphics[width=\textwidth]{figures/toy-no-full-scene.png}
    ...
    \caption{Same as figure \ref{fig:toy} but the shear is applied
    to the objects without shearing the space between them. This
    models the extreme and unrealistic case where two objects are in
