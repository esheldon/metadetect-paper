...
\citep{DawsonBlending2017}.  However, a method such as \mcal\ should be able
...
principle be shear dependent. This is demonstrated in panel XXX of figure
\ref{fig:toy} for the case of very small pixels and no point-spread-function
(PSF).  However, in the presence of a PSF and large pixels, objects overlap
differently after shearing, because the effect of the PSF occurs after the
mapping.  This is demonstrated in panel XXX of figure \ref{fig:toy}.
