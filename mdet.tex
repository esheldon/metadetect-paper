...
\begin{figure*}
    ...
    c) the shear is applied {\em before} the PSF convolution.  In this case the
    inner contours do not overlap after shearing.  If a detection algorithm
    always identified overlapping contours as one object, this effect would
    manifest as a shear-dependent detection bias.  \label{fig:toy} }
